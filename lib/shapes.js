...
class Triangle extends shape{
    ...
    render(){
        return `<polygon points="100,0 200,200 0,200" fill="${this.color}"></polygon>
        <text x="100" y="150" alignment-baseline="middle" fill="${this.font}" text-anchor="middle" font-size="20">${this.logo}</text>`
    }
};
