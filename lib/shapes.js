...
class Circle extends shape{
    ...
    render(){
        return `<circle cx="100" cy="100" r="100" fill="${this.color.toLowerCase()}"></circle>
    <text x="100" y="100" alignment-baseline="middle" fill="${this.font.toLowerCase()}" text-anchor="middle" font-size="20">${this.logo}</text>`
    }
};
...
class Square extends shape{
    ...
    render(){
        return `<rect x="0" y="0" width="300" height="200" fill="${this.color.toLowerCase()}"></rect>
